-- Functional languages practice 01
...
upAndDown n = undefined

-- Ex: list the numbers from n to -n: for example, downwards 4 should be [4,3,2,1,0,-1,-2,-3,-4]

downwards n = undefined
